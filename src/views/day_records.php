        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex m-5 justify-content-around">
                    <span class="record">Entry 1: <?= $records->time1 ?? '---' ?></span>
                    <span class="record">Exit 1: <?= $records->time2 ?? '---' ?></span>
                </div>
                <div class="d-flex m-5 justify-content-around">
                    <span class="record">Entry 2: <?= $records->time3 ?? '---' ?></span>
                    <span class="record">Exit 2: <?= $records->time4 ?? '---' ?></span>
                </div>
            </div>
